...
- **QA**: add [bugs as issues](issue) and comment them
...
- If you want to add a new feature, add a [suggestion issue](issue) first so that the community has the chance to discuss it and provide helpful input
